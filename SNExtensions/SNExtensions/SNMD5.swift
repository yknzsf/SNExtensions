...
//  SNExtensions
//
//  Created by shaofeng on 2017/6/7.
...
internal struct Digest {
    ...
    public var checksum: String {
        return SNMD5.encodeMD5(digest: digest)
    }
}

internal struct SNMD5 {
    ...
    internal static func md5(_ bytes: [Byte]) -> Digest {
        // Initialization
        let s: [Word] = [
    ...
    internal static func encodeMD5(digest: [Byte]) -> String {
        assert(digest.count == 16)
